...
$data = 'Token No. : ' . $row["booking_token"];
$data .= ', Date : ' . $row["booking_date"];
$data .= ', Name : ' . $row["full_name"];
$data .= ', Person : ' . $row["booking_people"];
$data .= ', Group : ' . $row["booking_group"];
$data .= ', Amount : ₹' . number_format($row["final_amt"],2);
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <div class="ticket3">
                                            ...
                                            <div class="ticket3__price">
                                                ...
                                                <img src="data:image/png;base64,<?= base64_encode($response) ?>" alt="QR Code">
                                            </div>
                                        </div>
                                    </div>
                                </div>
